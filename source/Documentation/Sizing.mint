component Documentation.Sizing {
  fun render {
    <>
      <Ui.Box title=<{ "Sizing" }>>
        <p>"This document describes the sizing system and how components are using it."</p>
      </Ui.Box>
      ...
      <DocBox
        ...
        content=<{
          ...
          <p>
            "When developing components use a pixel size first and th" \
            "en convert them to em using the 16px as the base. For ex" \
            "ample a 1px border becomes 0.0625em (1/16 = 0.0625), whi" \
            "ch then scales correctly."
          </p>
        }>/>
      ...
      <DocBox
        ...
        example={
          <Example
            data={
              @format {
                <div style="font-size: 16px">
                  <div style="font-size: 0.875em;border: 0.07142em solid gray;padding: 0.7142em;">
        ...
        content=<{
          <p>
            "Somethimes there is a need to change the font size and t" \
            "his changes all the ems which calculated for that elemen" \
            "t. In this case we need to calculate the changed font si" \
            "ze as the base."
          </p>
