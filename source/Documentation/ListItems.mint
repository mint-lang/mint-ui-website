  ...
  fun render {
    <>
      ...
      <DocBox
        ...
        content={
          <p>
            "Having a data structure to define list items allows us to " \
            "display lists in different ways. For example we can display " \
            "the same list in a "

            <a href="/components/ui-native-select">"Ui.Native.Select"</a>
            " and a normal "
            <a href="/components/ui-select">"Ui.Select"</a>
            "."
          </p>
        }
        example={
