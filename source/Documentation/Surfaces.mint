  ...
  fun render {
    <>
      ...
      <DocBox
        ...
        content=<>
          ...
          <p>
            ...
            <a href="/components/ui-box">"Ui.Box"</a>
            "."
          </p>
        </>
        example={
      ...
      <DocBox
        ...
        content=<>
          <p>
            "You can arrange any number of surfaces on a screen in any " \
            "number of ways just always make sure that there are gaps " \
        ...
        hint={
          <Ui.ContentHint icon={Ui.Icons.LIGHT_BULB} type="primary">
            "You can see that here around this note! There are small gaps " \
            "above and below which means that this is related to the those " \
            "surfaces."
          </Ui.ContentHint>
        }
        example={
