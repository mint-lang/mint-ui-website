  ...
  fun render : Html {
    <>
      <Ui.Box title=<>"Ui.ColorPanel"</>>
        <p>
          "A color panel allows you to pick a color in HSV color space, " \
          "where the hue is a vertical slider, the saturation and value is " \
          "a square input and the alpha is a horizontal slider."
        </p>
      </Ui.Box>
          ...
          <Example
            controls=<>
              <Ui.Field label="Size (#{size}px)">
                <Ui.Slider onChange={-> size} value={size} max={50} min={0}/>
              </Ui.Field>
      ...
      <DocBox
        ...
        content=<>
          ...
          <p>
            "This will remove the border and make the padding smaller. It's " \
            "mainly used to embed the panel into a picker."
          </p>
        </>
        example={
          <Example
