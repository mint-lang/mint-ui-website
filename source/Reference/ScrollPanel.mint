  ...
  fun render : Html {
    <>
      <Ui.Box title=<>"Ui.ScrollPanel"</>>
        <p>
          "This component offers a panel which can be scrolled either " \
          "horizontally or vertically while providing a hint (shadow) when " \
              ...
              @format {
                <>
                  <Ui.ScrollPanel orientation="vertical">
                    <div
                      style="width:300px;height:400px;background:var(--content-color)"
                    />
                  </Ui.ScrollPanel>

                  <Ui.ScrollPanel orientation="horizontal">
                    <div
                      style="width:400px;height:300px;background:var(--content-color)"
                    />
                  </Ui.ScrollPanel>
                </>
              }
              ...
              @format {
                <>
                  <Ui.ScrollPanel maxSize={50}>
                    <div
                      style="width:250px;height:300px;background:var(--content-color)"
                    />
                  </Ui.ScrollPanel>
              ...
              @format {
                <>
                  <Ui.ScrollPanel shadowSize={50}>
                    <div
                      style="width:250px;height:500px;background:var(--content-color)"
                    />
                  </Ui.ScrollPanel>
