      ...
      <Ui.Box title=<{ "Ui.FocusTrap" }>>
        ...
        <ul>
          <li>
            ...
            " on the last element in the component the focus will go " \
            "to the first focusable element in the component."
          </li>
          ...
          <li>
            ...
            " on the first element in the component the focus will go" \
            " to the last focusable element in the component."
          </li>
        </ul>
      </Ui.Box>
