  ...
  fun render : Html {
    <>
      <Ui.Box title=<>"Ui.Dropdown"</>>
        ...
        <p>
          "On desktop resolution the content is shown in a drop down panel " \
          "where as on mobile resolution it's shown in a modal."
        </p>
      </Ui.Box>
              ...
              data={
                @format {
                  <>
                    ...
                    <Ui.Dropdown
                      content={
                        <Ui.Dropdown.Panel>"A dropdown panel!"</Ui.Dropdown.Panel>
                      }
                      element={<Ui.Button label="Element"/>}
                      open={true}
                    />
      ...
      <DocBox
        ...
        content={
          <p>
            "Whether or not the panel should match the width the element can "
      ...
      <DocBox
        ...
        content={
          <p>
            "Whether or not the panel should close when clicking outside of "
            "the panel can be controlled with the "
