  ...
  fun render : Html {
    <>
      <Ui.Box title=<>"Ui.Slider"</>>
        <p>
          "This component lets the user specify a numeric value which must " \
          "be no less than a given value, and no more than another given " \
          "value."
        </p>
      </Ui.Box>
          ...
          <Example
            controls=<>
              ...
              <Ui.Field label="Step (#{step})">
                <Ui.Slider onChange={-> step} value={step} max={10} min={1}/>
              </Ui.Field>
