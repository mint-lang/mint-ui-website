    ...
    <>
      <Ui.Box title=<>"Ui.StickyPanel"</>>
        ...
        <ul>
          ...
          <li>
            "If the content cannot be shown at the requested position it " \
            "will be shown in the inverse position: "
          ...
          <Example
            controls=<>
              ...
              <Ui.Field label="Z-index (#{zIndex})">
                <Ui.Slider onChange={-> zIndex} value={zIndex} max={100} min={0}/>
              </Ui.Field>
              ...
              >
                <Ui.Checkbox
                  onChange={-> shouldCalculate}
                  checked={shouldCalculate}
                />
              </Ui.Field>

              <Ui.Field orientation={Ui.Field.Horizontal} label="Pass Through">
                <Ui.Checkbox onChange={-> passThrough} checked={passThrough}/>
              </Ui.Field>
            </>
            data={
              {
              ...
              @format {
                <>
                  <Ui.StickyPanel
                    content={
                      <div
                        style="width: 100px;height:50px;background:var(--primary-color);"
                      />
                    }
                    element={
                      <div
                        style="width: 250px;height:100px;background:var(--secondary-color);"
                      />
                    }
