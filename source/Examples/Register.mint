    ...
    let errors =
      Validation.merge(
        [
          ...
          Validation.isNotBlank(confirmation,
            {
              "password-confirmation",
              "Please enter the password for confirmation."
            }),
          Validation.isSame(password, confirmation,
            {
              "password-confirmation",
  ...
  fun render : Html {
    <Ui.Layout.Centered maxContentWidth="320px">
      <Ui.Column gap={Ui.Size.Em(1.5)}>
        ...
        <Ui.Content size={Ui.Size.Em(0.85)} textAlign="center">
          <div>
          ...
          <div>
            "Have an account? "
            <a href="/examples/login">"Login here."</a>
          </div>
        </Ui.Content>
      </Ui.Column>
    </Ui.Layout.Centered>
